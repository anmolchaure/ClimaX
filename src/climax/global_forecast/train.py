...
from ClimaX.src.climax.global_forecast.datamodule import GlobalForecastDataModule
from ClimaX.src.climax.global_forecast.module import GlobalForecastModule
